...
> **Node.js:** la app requiere **Node 22.12+** (lo exige Prisma 7 y Next 16; Node 22 es la versión LTS). El proyecto ya lo declara en `package.json` (`engines`) y `.nvmrc`, así que Railway instalará Node 22 automáticamente. No hace falta configuración adicional.
